...
* **Interactive Sidebar:** 
  * Personalized user card and online status.
...
3. Navigate to http://localhost:8000 using a modern browser like Google Chrome or Microsoft Edge for full Web Speech API compatibility.
